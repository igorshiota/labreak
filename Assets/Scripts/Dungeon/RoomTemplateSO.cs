...
public class RoomTemplateSO : ScriptableObject
{
    ...
    [Tooltip("The gameobject prefab for the room (this will contain all the tilemaps for the room and envinronment game objects")]
